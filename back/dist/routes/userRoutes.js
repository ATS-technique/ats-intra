...
router.post("/register", auth_1.default, userController_1.register);
...
router.get("/usersList", auth_1.default, userController_1.getAllUsers);
router.post("/forcePasswordUpdate", auth_1.default, userController_1.updatePasswordForce);
router.post("/updateScreenMode", auth_1.default, userController_1.upsateScreenMode);
